package com.spring.ivannikov.project2.config;
...
@Configuration
@ComponentScan("com.spring.ivannikov.project2")
@EnableWebMvc
@PropertySource("classpath:hibernate.properties")
@EnableTransactionManagement
@EnableJpaRepositories("com.spring.ivannikov.project2.repository")
public class AppContextConfig implements WebMvcConfigurer {
    private final ApplicationContext applicationContext;
    private final Environment environment;

    @Autowired
    public AppContextConfig(ApplicationContext applicationContext, Environment environment) {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        managerFactory.setPackagesToScan("com.spring.ivannikov.project2.entity");
